package cn.gloduck.api.service.index;

public class IndexHtmlContst {
    public static final String INDEX_PAGE = """
            ...
            <head>
                ...
                <style>
                    :root {
                        --primary-color: #249ffd;
                        --secondary-color: #31a3fc;
                        --light-bg: #f8f9fa;
                        --card-bg: #ffffff;
                        --text-color: #333333;
                        --text-light: #6c757d;
            ...
            <div class="container">
                ...
                <header>
                    ...
                    <div class="time-section">
                        ...
                        <div class="time-display" id="timeDisplay">14:30:45</div>
                    </div>
                </header>
                ...
                function fetchTools() {
                    setTimeout(() => {
                        const response = {
                            ...
                            msg: "成功",
                            data: [
                                {name: "Jrebel激活", href: "/jrebel", desc: "一键激活Jrebel开发工具", category: "开发"},
                                {name: "网络剪贴板", href: "/clipboard", desc: "多设备之间同步文本的网络剪贴板", category: "工具"}
                            ]
                        };
