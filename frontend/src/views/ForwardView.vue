    ...
    name: 'ForwardView',
            ...
            setup() {
                ...
                const startDownload = async () => {
                    ...
                    const proxyUrl = `/api/requestProxy${targetUrl.pathname}${targetUrl.search}${targetUrl.search ? '&' : '?'}Proxy-Host=${encodeURIComponent(`${targetUrl.protocol}//${targetUrl.host}`)}&Proxy-Enable-Cors=true`;
